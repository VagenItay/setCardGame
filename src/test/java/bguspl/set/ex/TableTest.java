...
class TableTest {
    ...
    private void RemoveSomeCardsAndAssert() throws InterruptedException {
        table.removeCard(2);
        boolean check1 = slotToCard[2]==null;
        boolean check2 = cardToSlot[8]==null;
    ...
    /**
     * remove some cards after fills some/all slot.
     * @pre - card is in slot 2 
     * @post - slot 2 is empty
     */
    @Test
    ...
    @Test 
    void removeAllCards_AllSlotsAreFilled() throws InterruptedException {
        fillAllSlots();
        RemoveSomeCardsAndAssert();
    }
